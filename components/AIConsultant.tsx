...
const chatMessages = [
  ...
  },
  {
    id: 2,
    type: 'ai',
    message: 'Какой прекрасный повод! 🎉 Учитывая ваш бюджет, могу п��едложить несколько вариантов. Что предпочитает ваша супруга: украшения, парфюм, технику или что-то уникальное?',
    timestamp: '14:32'
  },
  {
    id: 3,

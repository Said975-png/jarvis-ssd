...
const chatMessages = [
  ...
  },
  {
    id: 2,
    type: 'ai',
    message: 'Какой прекрасный повод! 🎉 Учитывая ваш бюджет, могу предложить ��есколько вариантов. Что предпочитает ваша супруга: украшения, парфюм, технику или что-то уникальное?',
    timestamp: '14:32'
  },
  {
    id: 3,

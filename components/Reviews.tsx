...
const reviews = [
  ...
  },
  {
    ...
    author: "Васильева О.",
    location: "��абережные Челны, Freelance"
  },
  {
    id: 7,
    rating: 5,
  ...
  },
  {
    id: 10,
    rating: 5,
    text: "Заказал сайт от Jarvis Intercoma онлайн-магазин с ИИ Джарвисом, �� не пожалел! Всё сделали быстро, магазин сразу начал приносить заказы. Особенно понравилось, что бот отвечает клиентам мгновенно, даже ночью.",
    author: "Карим",
    location: "Ташкент, Freelance"
  },
  {

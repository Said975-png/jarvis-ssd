...
const reviews = [
  ...
  },
  {
    id: 6,
    rating: 5,
    text: "Мой магазин ювелирных изделий стал более удобным благодаря Jarvis. Бот помогает клиентам выбрать подходящие ук��ашения и отвечает на все вопросы.",
    author: "Васильева О.",
  ...
  },
  {
    id: 10,
    rating: 5,
    text: "Заказал сайт от Jarvis Intercoma онлайн-магазин с ИИ Джарвисом, и не пожалел! Всё сделали быстро, магазин ср��зу начал приносить заказы. Особенно понравилось, что бот отвечает клиентам мгновенно, даже ночью.",
    author: "Карим",
    location: "Ташкент, Freelance"
  },
  {

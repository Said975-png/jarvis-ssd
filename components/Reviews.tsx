...
const reviews = [
  {
    id: 1,
    rating: 5,
    text: "Я не разбираю��ь в сайтах, но в Jarvis всё объяснили простыми словами. Сделал магазин, подключил оплату, и теперь я продаю в 3 странах. Рекомендую!",
    author: "Умид А.",
  ...
  },
  {
    id: 4,
    rating: 5,
    text: "Создала интернет-магазин с помощью Jarvis. Весь процесс автоматизирован, а бот отвечает на вопро��ы клиентов в любое время дня и ночи.",
    author: "Алексеева Л.",

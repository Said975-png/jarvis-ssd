            ...
            <div className="contract-panel-content">
              ...
              <div className="contract-step">
                ...
                <div className="step-content">
                  ...
                  <p className="step-description">
                    ��сли макет и техническое решение вас устраивает, мы заключаем договор и получаем предоплату 50 процентов от стоимо��ти проекта. Это позволяет нам приступить к разработке с полной уверенностью.
                  </p>
                </div>
              </div>
            ...
            <div className="features-panel-content">
              ...
              <div className="feature-item">
                <div className="feature-content">
                  ...
                  <p className="feature-description">
                    Наш ИИ общается с клиентами естественно и дружелюбно, отвечает на любые вопросы о товарах, помогает с выбором размера, цвета, характеристик. Клиен��ы даже не замечают, что говорят с роботом - настолько живое и понятное общение.
                  </p>
                </div>
              </div>
              ...
              <div className="feature-item">
                <div className="feature-content">
                  ...
                  <p className="feature-description">
                    Магазины с ДЖАРВИС показывают фантастические резул��таты. Продажи вырастают в среднем на 300 процентов. Клиенты покупают больше, возвращаются чаще и рекомендуют магазин друзьям. Средний чек увеличивается в 2 или 4 раза.
                  </p>
                </div>
              </div>

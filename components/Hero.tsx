            ...
            <div className="contract-panel-content">
              ...
              <div className="contract-step">
                ...
                <div className="step-content">
                  ...
                  <p className="step-description">
                    Проводим полное тестирование функционала, проверяем адаптивность на всех устройствах, оптимизируем скорость загрузки. Исправляем выявленные ошибки и д��рабатываем детали по вашим пожеланиям.
                  </p>
                </div>
              </div>
              ...
              <div className="contract-step">
                ...
                <div className="step-content">
                  ...
                  <p className="step-description">
                    Предлагаем техническую поддержку проекта, обновления и ��обавление новых функций. Помогаем масштабировать ваш бизнес с помощью дополнительных ИИ решений и интеграций.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="features-panel-content">
              ...
              <div className="feature-item">
                <div className="feature-content">
                  ...
                  <p className="feature-description">
                    Магазины с ДЖАРВИС показывают фантастические результаты. Продажи вырастают в среднем на 300 процентов. Клиенты покупают больше, возвращаются чаще и рекомендуют магазин друзьям. Средний чек увеличи��ается в 2 или 4 раза.
                  </p>
                </div>
              </div>
              ...
              <div className="feature-item">
                <div className="feature-content">
                  ...
                  <p className="feature-description">
                    Подключение ДЖАРВИС к вашему магазину занимает всего несколько дней. Никаких сложных ��астроек. Система сама изучает ваш ассортимент, цены и особенности бизнеса. Через неделю вы уже видите первые результаты роста продаж.
                  </p>
                </div>
              </div>
            </div>

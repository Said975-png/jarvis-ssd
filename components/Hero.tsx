            ...
            <div className="contract-panel-content">
              ...
              <div className="contract-step">
                ...
                <div className="step-content">
                  ...
                  <p className="step-description">
                    Приступаем к программированию и созданию вашего проекта. Макет корректируется и дорабатывается в пр��цессе работы для достижения наилучшего результата. Мы не меняем макет по не��колько раз без весомых оснований.
                  </p>
                </div>
              </div>
            ...
            <div className="features-panel-content">
              <div className="feature-item">
                <div className="feature-content">
                  ...
                  <p className="feature-description">
                    ДЖАРВИС анализир��ет поведение каждого клиента в реальном времени и предлагает именно те товары, которые им нужны. Он понимает предпочтения покупателей лучше, чем они сами, изучая их историю покупок и поисковые запросы.
                  </p>
                </div>
              </div>
              ...
              <div className="feature-item">
                <div className="feature-content">
                  ...
                  <p className="feature-description">
                    ДЖАРВИС создает уникальный профиль каждого покупателя и предлагает товары, которые идеально подходят именно ему. Система учитывает сезон, праздники, предыдущие покупки и даже настроение кли��нта по его сообщениям.
                  </p>
                </div>
              </div>
              ...
              <div className="feature-item">
                <div className="feature-content">
                  ...
                  <p className="feature-description">
                    Подключение ДЖАРВИС к вашему магазину занимает всего несколько дней. Никаких сложных настроек. Система сама изучает ваш ассо��тимент, цены и особенности бизнеса. Через неделю вы уже видите первые результаты роста продаж.
                  </p>
                </div>
              </div>
            </div>

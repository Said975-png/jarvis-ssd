          ...
          <div className="contract-panel" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="contract-panel-content">
              ...
              <div className="contract-step">
                ...
                <div className="step-content">
                  <h3 className="step-title">Р��зработка проекта</h3>
                  <p className="step-description">
            ...
            <div className="features-panel-content">
              <div className="feature-item">
                <div className="feature-content">
                  ...
                  <p className="feature-description">
                    ДЖАРВИС анализирует поведение каждого клиента в реальном времен�� и предлагает именно те товары, которые им нужны. Он понимает предпочтения покупателей лучше, чем они сами, изучая их историю покупок и поисковые запросы.
                  </p>
                </div>
              </div>
              ...
              <div className="feature-item">
                <div className="feature-content">
                  ...
                  <p className="feature-description">
                    Подключение ДЖАРВИС к вашему магазину занимает всего несколько дней. Никаких сложных настроек. Система сама изучает ваш ассортимент, цены и особенности бизнеса. Через недел�� вы уже видите первые результаты роста продаж.
                  </p>
                </div>
              </div>
            </div>

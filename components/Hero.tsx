            ...
            <div className="contract-panel-content">
              ...
              <div className="contract-step">
                ...
                <div className="step-content">
                  ...
                  <p className="step-description">
                    После завершения разработки и получения окончательного плат��жа мы передаем вам готовый проект. Предоставляем инструкции по использованию, помогаем с размещением на хостинге и даем гарантию на исправление ошибок.
                  </p>
                </div>
              </div>
            ...
            <div className="features-panel-content">
              ...
              <div className="feature-item">
                <div className="feature-content">
                  ...
                  <p className="feature-description">
                    ДЖАРВИС никогда не спит, не устает и не берет выходные. Он отвечает клиентам мгновен��о в любое время дня и ночи, обрабатывает сотни обращений одновременно и никогда не теряет терпение даже с самыми сложными покупателями.
                  </p>
                </div>
              </div>

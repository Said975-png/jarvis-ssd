...
export async function POST(request: NextRequest) {
  try {
    ...
    const systemMessage: Message = {
      role: 'system',
      content: `Ты Джарвис — умный AI-ассистент. Отвечай кратко, просто и по делу.
...
- Простые слова
- Прямые ответы без лишней информации
- Если нужны подробности, спроси "хотите узнать больше?"

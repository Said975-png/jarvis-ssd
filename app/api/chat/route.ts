...
export async function POST(request: NextRequest) {
  try {
    ...
    const systemMessage: Message = {
      role: 'system',
      content: `Ты умный и полезный AI-ассистент. Отвечай на русском языке естественно и дружелюбно. 
      Ты можешь помочь с любыми вопросами, задачами, объяснениями. Будь краткими и понятным, но информативным.
      Если пользователь спрашивает о чем-то техническом, объясни это простыми словами.`
    };
